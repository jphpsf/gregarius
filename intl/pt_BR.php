...
define ('LBL_H2_UNREAD_ITEMS','&Iacute;tens n&atilde;o lidos(<strong id="ucnt">%d</strong>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> &iacute;tens (<strong id="fucnt">%d</strong> n&atilde;o lidos) em <strong>%d</strong> feeds');
...
define ('LBL_ADMIN_CHANNEL_PRIVATE','Este feed Ã© <strong>privado</strong>, somente administradores podem v&ecirc;-lo.');
define ('LBL_ADMIN_CHANNEL_DELETED','Este feed Ã© <strong>depreciado</strong>, ele n&atilde;o deve ser mais atualizado e n&atilde;o deve ser vis&iacute;vel na coluna de feeds.');
...
define ('LBL_ADMIN_PRUNE_INCLUDE_STICKY','Excluir &iacute;tens Pregados tambÃ©m: ');
...
define ('LBL_ADMIN_MUST_SET_PASS','<p>Nenhum administrador foi especificado ainda!</p>'
		.'<p>Por favor forneça um usu&aacute;rio e senha para o Administrador agora!</p>');
...
define ('LBL_ADMIN_PASS_NO_MATCH','Senhas não conferem!');
...
define ('LBL_ADMIN_LOGIN_BAD_LOGIN','<strong>Oops!</strong> Senha ou usu&aacute;rio inválido');
