...
define ('LBL_H2_UNREAD_ITEMS','&Iacute;tems n&atilde;o lidos(<span id="ucnt">%d</span>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> &iacute;tems (<strong>%d</strong> n&atilde;o lidos) em <strong>%d</strong> feeds');
