...
define ('LBL_H2_UNREAD_ITEMS','Ungelesene Artikel (<strong id="ucnt">%d</strong>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> Artikel (<strong id="fucnt">%d</strong> ungelesen) in <strong>%d</strong> Feeds');
