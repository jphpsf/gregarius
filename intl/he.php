...
define ('LBL_H2_UNREAD_ITEMS','רשומות שלא נקראו (<strong id="ucnt">%d</strong>)');
define ('LBL_H2_RECENT_ITEMS', "רשומות קודמות");
define ('LBL_H2_CHANNELS','ערוצים');
define ('LBL_H5_READ_UNREAD_STATS','%d רשומות, %d לא נקראו');
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> רשומות (<strong id="fucnt">%d</strong> לא נקראו) ב<strong>%d</strong> ערוצים');
