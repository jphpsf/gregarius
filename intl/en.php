...
define ('LBL_H2_UNREAD_ITEMS','Unread items (<strong id="ucnt">%d</strong>)');
define ('LBL_H2_RECENT_ITEMS', "Recent items");
define ('LBL_H2_CHANNELS','Feeds');
define ('LBL_H5_READ_UNREAD_STATS','%d items, %d unread');
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> items (<strong id="fucnt">%d</strong> unread) in <strong>%d</strong> feeds');
