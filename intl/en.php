...
define ('ADMIN_CHANNELS_HEADING_FLAGS','Flags');
...
define ('ADMIN_CHANNEL_PRIVATE','This feed is <strong>private</strong>, only admins see it.');
define ('ADMIN_CHANNEL_DELETED','This feed is <strong>deprecated</strong>, it won\'t be updated anymore and won\'t be visible in the feeds column.');
