...
define ('ADMIN_CHANNELS_HEADING_FLAGS','Etat');
...
define ('ADMIN_PLUGINS_HEADING_ACTION','Actif');
...
define ('ADMIN_CHANNEL_DELETED','Ce canal est <strong>desactiv&eacute;</strong>, il ne sera plus mis &agrave; jour et n\'est pas visible dans la colonne des canaux.');
...
define ('MARK_FOLDER_READ', "Marquer ce r&eacute;pertoire comme lu");
