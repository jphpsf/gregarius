...
define ('LBL_H2_UNREAD_ITEMS','&Eacute;l&eacute;ments non lus (<strong id="ucnt">%d</strong>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> &eacute;l&eacute;ments (<strong id="fucnt">%d</strong> non lus) dans <strong>%d</strong> canaux');
...
define ('LBL_NAV_UPDATE', 'Mise &agrave; jo<span>u</span>r');
define ('LBL_NAV_CHANNEL_ADMIN', 'A<span>d</span>ministration');
define ('LBL_NAV_SEARCH', "<span>R</span>echerche");
...
define('LBL_FOOTER_LAST_MODIF_NEVER', 'aucune');
