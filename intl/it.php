...
define ('LBL_H2_UNREAD_ITEMS','<strong id="ucnt">%d</strong> elementi non letti');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> elementi (<strong id="fucnt">%d</strong> non letti) in <strong>%d</strong> feed');
