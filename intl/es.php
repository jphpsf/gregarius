...
define ('LBL_H2_UNREAD_ITEMS','temas sin leer (<strong id="ucnt">%d</strong>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> temas (<strong id="fucnt">%d</strong> sin leer) en <strong>%d</strong> canales');
