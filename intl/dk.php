...
define ('LBL_H2_UNREAD_ITEMS','Ul&aelig;ste items (<strong id="ucnt">%d</strong>)');
...
define ('LBL_ITEMCOUNT_PF', '<strong>%d</strong> items (<strong id="fucnt">%d</strong> unread) i <strong>%d</strong> feeds');
