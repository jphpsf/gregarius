...
function setDefaults($key) {
	...
	$defaults = array (
		...
		"rss.config.serverpush"		=>		array("true","true","boolean","Use server push method when updating your feeds in the browser. The browsers that support this (Mozilla and Opera), will be autodetected. Turn this config option if you do not use one of these browsers or if you would like to use the Ajax update method",NULL),
		"rss.config.refreshafter"	=>		array("45","45","num","If this option is set the feeds will be refreshed updated after keeping the browser open for x minutes. Please respect the feed providers by not setting this value to anything lower than thirty minutes. Set this variable to 0 turn this option off.",NULL),
