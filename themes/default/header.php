	...
	<link rel="stylesheet" type="text/css" href="<?php echo rss_theme_path() ?>/css/layout.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo rss_theme_path() ?>/css/look.css" />
