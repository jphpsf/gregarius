...
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.output.lang","en,fr,0","en,fr,0","enum","Language pack to use.",NULL);
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.config.absoluteordering","true","true","boolean","Allow ordering of channels in the admin section. \n If false, channels will be organized by title.",NULL);
