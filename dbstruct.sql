...
insert into config (key_,value_,default_,type_,desc_,export_) values
("rss.output.frontpage.mixeditems",'true','true','boolean','Show read items along with unread items on the front page?',NULL);
