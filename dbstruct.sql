...
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.config.showdevloglink","true","true","boolean","Show a link to the gregarius devlog. This is mainly useful on the actual\n live gregarius site (http://gregarius.net/).You can safely set this to \'false\'\n if you don\'t want to display a link back.",NULL);
...
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.output.channelcollapse","true","true","boolean","Allow collpasing of channels on the main page. ",NULL);
...
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.config.markreadonupdate","true","true","boolean","Mark all old unread feeds as read when updating, if new unread feeds\n are found ",NULL);
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.output.lang","en,fr,0","en,fr,0","enum","Language pack to use. (As of today \'en\' and \'fr\' ar available)",NULL);
INSERT INTO `config` (`key_`,`value_`,`default_`,`type_`,`desc_`,`export_`) VALUES ("rss.config.absoluteordering","true","true","boolean","Allow ordering of channels in the admin. \n (Uses channel title instead)",NULL);
